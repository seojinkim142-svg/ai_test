  ...
  ko: {
    ...
    pricing: {
      ...
      rows: [
        ...
        { label: "월 요금", values: { free: "무료", pro: "6,900원 / 월", premium: "18,900원 / 월" } },
  ...
  zh: {
    ...
    pricing: {
      ...
      rows: [
        ...
        { label: "月费", values: { free: "免费", pro: "₩6,900 / 月", premium: "₩18,900 / 月" } },
  ...
  ja: {
    ...
    pricing: {
      ...
      rows: [
        ...
        { label: "月額", values: { free: "無料", pro: "₩6,900 / 月", premium: "₩18,900 / 月" } },
  ...
  hi: {
    ...
    pricing: {
      ...
      rows: [
        ...
        { label: "मासिक शुल्क", values: { free: "मुफ़्त", pro: "₩6,900 / माह", premium: "₩18,900 / माह" } },
  ...
  en: {
    ...
    pricing: {
      ...
      rows: [
        ...
        { label: "Monthly price", values: { free: "Free", pro: "?6,900 / month", premium: "?18,900 / month" } },
