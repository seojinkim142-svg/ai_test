    ...
    return (
      <div className="rounded-3xl border border-white/10 bg-slate-900/70 p-4 shadow-lg shadow-black/30">
        <div className="flex flex-col items-center gap-4 rounded-3xl border border-black/5 bg-white px-6 py-10 text-center shadow-lg shadow-black/10">
          ...
          <p className="text-sm text-slate-500">{questions.length}문항 · 정답 {score}개 · 오답 {questions.length - score}개</p>
          <button
            type="button"
            onClick={restart}
            className="mt-2 ghost-button text-sm text-violet-200"
            data-ghost-size="sm"
  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-slate-900/70 p-4 shadow-lg shadow-black/30">
      <div className="flex flex-col gap-3">
        ...
        {/* 문제 카드 */}
        <div className="flex flex-col items-center justify-center rounded-3xl border border-black/5 bg-white px-8 py-8 text-center shadow-lg shadow-black/10">
