...
const FileUpload = memo(function FileUpload({
  ...
  const uploadGridClassName = isNativePlatform
    ? `relative mt-1 grid gap-3 sm:mt-2 ${sidebarOpen ? "grid-cols-5" : "grid-cols-6"}`
    : `relative mt-1 grid gap-3 sm:mt-2 ${sidebarOpen ? "grid-cols-1 sm:grid-cols-5" : "grid-cols-2 sm:grid-cols-6"}`;
