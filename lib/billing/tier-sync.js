...
export const resolvePaidTierPricing = ({ requestedTier = "", requestedMonths = 1 } = {}) => {
  ...
  const months = normalizeMonths(requestedMonths, 1);
  const amount = Number(PAID_TIER_BASE_AMOUNT[tier] || 0) * months;
